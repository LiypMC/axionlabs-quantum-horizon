...
import { Loader2, ArrowLeft, User, Settings as SettingsIcon, Shield, Cpu, Zap } from 'lucide-react';
        ...
        <Card className="w-full max-w-4xl glass-panel border-primary/20 shadow-2xl backdrop-blur-xl">
          ...
          <CardContent className="p-8">
            <Tabs defaultValue="profile" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-8 bg-background/20 border border-border/30 h-12">
                <TabsTrigger 
                  value="profile" 
